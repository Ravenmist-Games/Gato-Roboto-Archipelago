...
region_data_table: Dict[str, GatoRobotoRegionData] = {
    ...
    RegionName.region_nexus: GatoRobotoRegionData([RegionName.region_aqueducts, RegionName.region_heater_core,
                                                   RegionName.region_ventilation, RegionName.region_incubator]),
